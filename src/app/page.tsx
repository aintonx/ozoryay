...
import { clockInTz, separationDays } from "@/lib/time/days";
...
export default function Page() {
  ...
  const clock = clockInTz(now, settings.herTimezone);

  return (
    <main className="relative h-[100dvh] w-full overflow-hidden">
      <Night counter={{ days, ...clock }} settings={settings} letters={letters} />
    </main>
  );
}
