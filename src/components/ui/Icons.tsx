...
/**
 * Созвездие: несколько звёзд, соединённых тонкими линиями.
 * Полностью в языке остальных иконок — только stroke, без заливок.
 */
export function IconConstellation({ className, size }: IconProps) {
  return (
    <svg {...base(size)} className={className}>
      ...
      <path d="M18.2 11.2l.45 1.05 1.05.45-1.05.45-.45 1.05-.45-1.05-1.05-.45 1.05-.45z" />
